...
class TablesService {
     ...
     * @throws ApiError
     */
    static async getTablesServiceRcmsApi1TablesSimple(requestParam) {
     ...
     * @throws ApiError
     */
    static async getTablesServiceRcmsApi1TablesMatrix(requestParam) {
        const shouldHookToken = Object.keys({
            'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
        }).length > 0;
        const request = async () => await request_1.request({
     ...
     * @throws ApiError
     */
    static async getTablesServiceRcmsApi1TablesDate(requestParam) {
        const shouldHookToken = Object.keys({
            'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
        }).length > 0;
        const request = async () => await request_1.request({
     ...
     * @throws ApiError
     */
    static async getTablesServiceRcmsApi1TablesChecksheet(requestParam) {
        const shouldHookToken = Object.keys({
            'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
        }).length > 0;
        const request = async () => await request_1.request({
     ...
     * @throws ApiError
     */
    static async getTablesServiceRcmsApi1TablesInvalid(requestParam) {
        const shouldHookToken = Object.keys({
            'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
        }).length > 0;
        const request = async () => await request_1.request({
     ...
     * @throws ApiError
     */
    static async getTablesServiceRcmsApi1TablesSimpleKey1Value2(requestParam) {
        const shouldHookToken = Object.keys({
            'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
        }).length > 0;
        const request = async () => await request_1.request({
