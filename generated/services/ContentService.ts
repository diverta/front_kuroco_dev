...
export class ContentService {
     ...
     * @throws ApiError
     */
    public static async getContentService({
        topicsId,
        outputFormat,
        lang,
        charset,
        ...
        const result = await __request({
            method: 'GET',
            path: `/rcms-api/1/topics1/${topicsId}`,
            query: {
     ...
     * @throws ApiError
     */
    public static async getContentService1({
        outputFormat,
        lang,
        charset,
        cnt,
        ...
        /** The ID from the displayed category. All data will be displayed when this is not set. **/
        contentsType?: Array<number>,
        /** Change the way of narrowing down by category ID (Default: OR) **/
        contentsTypeCond?: string,
        /** Date **/
        date?: string,
        /** Use season (Yes: 1 | No: 0) **/
        usingSeason?: string,
        /** Season **/
        season?: number,
        /** ext_column condition type (Default:OR)<br>
         * To specify an ext_col number set: 'ext_column_{no}_cond' **/
        extColumnCond?: string,
        /** IDs of the excluded topics **/
        excludeTopicsId?: string,
        /** ID of the tag category to be displayed. (Default: All) **/
        tagCategoryId?: number,
        /** narrowed by the value of the tag id.  yes:1 no:0 **/
        tagSearch?: string,
        /** Tag IDs that you would like to display **/
        tagId?: Array<number>,
        /** Change the way to narrow down tags (Default: OR) **/
        tagCond?: string,
        /** Tag IDs that you would like to hide **/
        excludeTagId?: string,
        ...
        order?: string,
        orderById?: string,
        /** IDs of the displayed topics **/
        id?: Array<number>,
        /** List type as (array or object) **/
        type?: string,
        /** Grouping List by (category) **/
        groupBy?: string,
        /** Category id list (using with groupBy category) **/
        groupByCategoryId?: Array<number>,
        /** Show empty category info (using with groupBy category) **/
        showEmptyCategories?: boolean,
        /** Order by category contents count (using with groupBy category) **/
        ...
        const result = await __request({
            ...
            query: {
                ...
                'contents_type_cond': contentsTypeCond,
                'date': date,
                'using_season': usingSeason,
                'season': season,
                'ext_column_cond': extColumnCond,
                'exclude_topics_id': excludeTopicsId,
                ...
                'my_comment_list': myCommentList,
                'my_own_list': myOwnList,
                'order': order,
                'order_by_id': orderById,
                'id[]': id,
                'type': type,
                'groupBy': groupBy,
                'group_by_category_id[]': groupByCategoryId,
                'show_empty_categories': showEmptyCategories,
                'order_by_category_count': orderByCategoryCount,
            },
        });
        return result.body;
    }
     ...
     * @throws ApiError
     */
    public static async postContentService({
        requestBody,
        outputFormat,
        lang,
        charset,
        ...
        requestBody: {
            ...
            ext_col_06: ({
                key?: '1' | '2' | '3' | '4' | '5',
                label?: 'Parent1' | 'Parent2' | 'Parent3' | 'Parent4' | 'Parent5',
            } | '1' | '2' | '3' | '4' | '5'),
            /**
             * Relation
             */
     ...
     * @throws ApiError
     */
    public static async postContentService1({
        topicsId,
        requestBody,
        outputFormat,
        lang,
        ...
        const result = await __request({
            method: 'POST',
            path: `/rcms-api/1/topics1/update/${topicsId}`,
            query: {
                '_output_format': outputFormat,
                '_lang': lang,
                '_charset': charset,
     ...
     * @throws ApiError
     */
    public static async postContentService2({
        topicsId,
        outputFormat,
        lang,
        charset,
        ...
        const result = await __request({
            method: 'POST',
            path: `/rcms-api/1/topics1/delete/${topicsId}`,
            query: {
                '_output_format': outputFormat,
                '_lang': lang,
                '_charset': charset,
     ...
     * @throws ApiError
     */
    public static async getContentService2({
        outputFormat,
        lang,
        charset,
        cnt,
     ...
     * @throws ApiError
     */
    public static async getContentService3({
        topicsId,
        outputFormat,
        lang,
        charset,
        ...
        const result = await __request({
            method: 'GET',
            path: `/rcms-api/1/topics/multiple/${topicsId}`,
            query: {
                '_output_format': outputFormat,
                '_lang': lang,
                '_charset': charset,
     ...
     * @throws ApiError
     */
    public static async postContentService3({
        requestBody,
        outputFormat,
        lang,
        charset,
        ...
        requestBody: {
             ...
             * Date
             */
            ext_col_07: Array<(string | {
                ymd?: string,
            })>,
            /**
             * DateTime
             */
            ext_col_08: Array<(string | {
                ymd?: string,
                'h'?: number,
                'i'?: number,
            })>,
     ...
     * @throws ApiError
     */
    public static async postContentService4({
        topicsId,
        requestBody,
        outputFormat,
        lang,
        ...
        const result = await __request({
            method: 'POST',
            path: `/rcms-api/1/topics/multiple/update/${topicsId}`,
            query: {
                '_output_format': outputFormat,
                '_lang': lang,
                '_charset': charset,
     ...
     * @throws ApiError
     */
    public static async getContentService4({
        outputFormat,
        lang,
        charset,
        cnt,
     ...
     * @throws ApiError
     */
    public static async getContentService5({
        topicsId,
        outputFormat,
        lang,
        charset,
        ...
        const result = await __request({
            method: 'GET',
            path: `/rcms-api/1/topics/static/${topicsId}`,
            query: {
                '_output_format': outputFormat,
                '_lang': lang,
                '_charset': charset,
     ...
     * @throws ApiError
     */
    public static async postContentService5({
        topicsId,
        outputFormat,
        lang,
        charset,
        ...
        const result = await __request({
            method: 'POST',
            path: `/rcms-api/1/topics/multiple/delete/${topicsId}`,
            query: {
                '_output_format': outputFormat,
                '_lang': lang,
                '_charset': charset,
     ...
     * @throws ApiError
     */
    public static async getContentService6({
        outputFormat,
        lang,
        charset,
        cnt,
     ...
     * @throws ApiError
     */
    public static async getContentService7({
        outputFormat,
        lang,
        charset,
    }: {
     ...
     * @throws ApiError
     */
    public static async getContentService8({
        outputFormat,
        lang,
        charset,
        cnt,
     ...
     * @throws ApiError
     */
    public static async getContentService9({
        previewToken,
        outputFormat,
        lang,
        charset,
