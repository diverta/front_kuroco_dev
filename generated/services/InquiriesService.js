...
class InquiriesService {
     ...
     * @throws ApiError
     */
    static async getInquiriesServiceRcmsApi1InquiryForms(requestParam) {
     ...
     * @throws ApiError
     */
    static async getInquiriesServiceRcmsApi1InquiryFormsInquiryId(requestParam) {
        const shouldHookToken = Object.keys({
            'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
        }).length > 0;
        const request = async () => await request_1.request({
     ...
     * @throws ApiError
     */
    static async getInquiriesServiceRcmsApi1Inquiry1Messages(requestParam) {
        const shouldHookToken = Object.keys({
            'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
        }).length > 0;
        const request = async () => await request_1.request({
     ...
     * @throws ApiError
     */
    static async postInquiriesServiceRcmsApi1Inquiry1MessagesSend(requestParam) {
        const shouldHookToken = Object.keys({
            'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
        }).length > 0;
        const request = async () => await request_1.request({
     ...
     * @throws ApiError
     */
    static async postInquiriesServiceRcmsApi1Inquiry1MessagesUpdate(requestParam) {
        const shouldHookToken = Object.keys({
            'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
        }).length > 0;
        const request = async () => await request_1.request({
