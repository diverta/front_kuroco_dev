...
class InquiriesService {
            ...
            const request = () => __awaiter(this, void 0, void 0, function* () {
                return yield request_1.request({
                    ...
                    query: {
                        ...
                        'filter': requestParam.filter,
                        'order_query': requestParam.orderQuery,
     ...
     * @throws ApiError
     */
    static postInquiriesServiceRcmsApi1Inquiry1MessagesUpdateInquiryBnId(requestParam) {
        return __awaiter(this, void 0, void 0, function* () {
            const shouldHookToken = Object.keys({
                'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
            }).length > 0;
            const request = () => __awaiter(this, void 0, void 0, function* () {
                return yield request_1.request({
                    headers: shouldHookToken ? { [OpenAPI_1.OpenAPI.SECURITY['Token-Auth'].name]: `${LocalStorage_1.LocalStorage.getAccessToken()}` } : {},
                    method: 'post',
                    path: `/rcms-api/1/inquiry1/messages/update/${requestParam.inquiryBnId}`,
                    query: {
                        '_output_format': requestParam.outputFormat,
                        '_lang': requestParam.lang,
                        '_charset': requestParam.charset,
     ...
     * @throws ApiError
     */
    static postInquiriesServiceRcmsApi1InquiryFormsInsert(requestParam) {
        return __awaiter(this, void 0, void 0, function* () {
            const shouldHookToken = Object.keys({
                'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
            }).length > 0;
     ...
     * @throws ApiError
     */
    static postInquiriesServiceRcmsApi1InquiryFormsUpdateInquiryId(requestParam) {
        return __awaiter(this, void 0, void 0, function* () {
            const shouldHookToken = Object.keys({
                'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
            }).length > 0;
            const request = () => __awaiter(this, void 0, void 0, function* () {
                return yield request_1.request({
                    headers: shouldHookToken ? { [OpenAPI_1.OpenAPI.SECURITY['Token-Auth'].name]: `${LocalStorage_1.LocalStorage.getAccessToken()}` } : {},
                    method: 'post',
                    path: `/rcms-api/1/inquiry/forms/update/${requestParam.inquiryId}`,
                    query: {
                        '_output_format': requestParam.outputFormat,
                        '_lang': requestParam.lang,
                        '_charset': requestParam.charset,
     ...
     * @throws ApiError
     */
    static postInquiriesServiceRcmsApi1Form7Send(requestParam) {
        return __awaiter(this, void 0, void 0, function* () {
            const shouldHookToken = Object.keys({
                'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
            }).length > 0;
...
exports.infos = [
    ...
    },
    {
        ...
        export interface postInquiriesServiceRcmsApi1Inquiry1MessagesSendRequest {
            requestBody: {
                ...
                ext_11?: any | { col1: string ,col2: string ,col3: string  },
                ext_12?: any | { col1: string ,col2: string ,col3: string  },
                /**
                 * Message
                 */
                body: string,
    ...
    },
    {
        ...
        class: InquiriesService,
        className: 'InquiriesService',
        method: InquiriesService.postInquiriesServiceRcmsApi1Inquiry1MessagesUpdateInquiryBnId,
        methodName: 'postInquiriesServiceRcmsApi1Inquiry1MessagesUpdateInquiryBnId',
        auth: null,
        description: `
        export interface postInquiriesServiceRcmsApi1Inquiry1MessagesUpdateInquiryBnIdRequest {
            inquiryBnId: number,
            requestBody: {
                /**
                 * Name
                 ...
                 * * 20 => Replies
                 */
                status?: { key: string ,label: string  } | '' | '0' | '5' | '10' | '20',
                /**
                 * Admin's memo
                 */
                comment?: string,
        ...
        export type postInquiriesServiceRcmsApi1Inquiry1MessagesUpdateInquiryBnIdResponse = any;
        `,
    },
    {
        path: '/rcms-api/1/inquiry/forms/insert',
        ...
        class: InquiriesService,
        className: 'InquiriesService',
        method: InquiriesService.postInquiriesServiceRcmsApi1InquiryFormsInsert,
        methodName: 'postInquiriesServiceRcmsApi1InquiryFormsInsert',
        auth: null,
        description: `
        export interface postInquiriesServiceRcmsApi1InquiryFormsInsertRequest {
            requestBody: {
                /**
                 * Title
                 */
        ...
        export type postInquiriesServiceRcmsApi1InquiryFormsInsertResponse = any;
        `,
    },
    {
        path: '/rcms-api/1/inquiry/forms/update/${requestParam.inquiryId}',
        ...
        class: InquiriesService,
        className: 'InquiriesService',
        method: InquiriesService.postInquiriesServiceRcmsApi1InquiryFormsUpdateInquiryId,
        methodName: 'postInquiriesServiceRcmsApi1InquiryFormsUpdateInquiryId',
        auth: null,
        description: `
        export interface postInquiriesServiceRcmsApi1InquiryFormsUpdateInquiryIdRequest {
            inquiryId: number,
            requestBody: {
                /**
                 * Title
        ...
        export type postInquiriesServiceRcmsApi1InquiryFormsUpdateInquiryIdResponse = any;
        `,
    },
    {
        path: '/rcms-api/1/form/7/send',
        ...
        class: InquiriesService,
        className: 'InquiriesService',
        method: InquiriesService.postInquiriesServiceRcmsApi1Form7Send,
        methodName: 'postInquiriesServiceRcmsApi1Form7Send',
        auth: null,
        description: `
        export interface postInquiriesServiceRcmsApi1Form7SendRequest {
            requestBody: {
                /**
                 * Name
                 */
                 ...
                 * * 4 => radio4
                 */
                ext_03?: { key: string ,label: string  } | '' | '1' | '2' | '3' | '4',
                /**
                 * RequiredSelect
                 * * 1 => select1
                 * * 2 => select2
                 ...
                 * * 4 => check4
                 */
                ext_05?: Array<{ key: string ,label: string  } | '1' | '2' | '3' | '4'>,
                /**
                 * Date
                 */
                ext_06?: string | string | { y: number ,m: number ,d: number ,h: number ,mm: number  },
        ...
        export type postInquiriesServiceRcmsApi1Form7SendResponse = any;
        `,
    },
];
