...
class TagsService {
     ...
     * @throws ApiError
     */
    static async getTagsServiceRcmsApi1Tags(requestParam) {
     ...
     * @throws ApiError
     */
    static async postTagsServiceRcmsApi1TagsInsert(requestParam) {
        const shouldHookToken = Object.keys({
            'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
        }).length > 0;
        const request = async () => await request_1.request({
     ...
     * @throws ApiError
     */
    static async postTagsServiceRcmsApi1TagsDeleteTagId(requestParam) {
        const shouldHookToken = Object.keys({
            'Token-Auth': OpenAPI_1.OpenAPI.SECURITY['Token-Auth'],
        }).length > 0;
        const request = async () => await request_1.request({
