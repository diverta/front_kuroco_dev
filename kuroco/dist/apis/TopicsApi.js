...
import { InlineObject3Description, InlineObject3ToJSON, InlineObject4Description, InlineObject4ToJSON, InlineObject5Description, InlineObject5ToJSON, InlineObject6Description, InlineObject6ToJSON, } from '../models';
...
var TopicsApiRcmsApi1TopicsMultipleGetRequestDescription = (function (usingModelsDescription) { return "{\n    outputFormat?: string;\n    lang?: string;\n    charset?: string;\n    cnt?: number;\n    pageID?: number;\n    customSearchId?: string;\n    topicsKeyword?: string;\n    topicsKeywordCond?: string;\n    contentsType?: Array<number>;\n    contentsTypeCond?: string;\n    date?: string;\n    usingSeason?: string;\n    season?: number;\n    extColumnCond?: string;\n    excludeTopicsId?: string;\n    tagCategoryId?: number;\n    tagSearch?: string;\n    tagId?: Array<number>;\n    tagCond?: string;\n    excludeTagId?: string;\n    myFavoriteList?: number;\n    myCommentList?: number;\n    myOwnList?: string;\n    order?: string;\n    orderById?: string;\n    id?: Array<number>;\n}"; })(usingModelsDescription);
var TopicsApiRcmsApi1TopicsMultipleInsertPostRequestDescription = (function (usingModelsDescription) { return "{\n    inlineObject5: " + usingModelsDescription.InlineObject5 + ";\n    outputFormat?: string;\n    lang?: string;\n    charset?: string;\n}"; })(usingModelsDescription);
var TopicsApiRcmsApi1TopicsMultipleTopicsIdGetRequestDescription = (function (usingModelsDescription) { return "{\n    topicsId: number;\n    outputFormat?: string;\n    lang?: string;\n    charset?: string;\n}"; })(usingModelsDescription);
var TopicsApiRcmsApi1TopicsMultipleUpdateTopicsIdPostRequestDescription = (function (usingModelsDescription) { return "{\n    topicsId: number;\n    inlineObject6: " + usingModelsDescription.InlineObject6 + ";\n    outputFormat?: string;\n    lang?: string;\n    charset?: string;\n}"; })(usingModelsDescription);
/**
 * no description
 */
var TopicsApi = /** @class */ (function (_super) {
    ...
    Object.defineProperty(TopicsApi, "infos", {
        get: function () {
            return [
                ...
                {
                    class: TopicsApi,
                    url: "/rcms-api/1/topics/multiple",
                    requestMethodName: 'rcmsApi1TopicsMultipleGet',
                    requestRequiredParamSample: {},
                    requestParamInterfaceDescription: TopicsApiRcmsApi1TopicsMultipleGetRequestDescription,
                },
                {
                    class: TopicsApi,
                    url: "/rcms-api/1/topics/multiple/insert",
                    requestMethodName: 'rcmsApi1TopicsMultipleInsertPost',
                    requestRequiredParamSample: {
                        inlineObject5: {},
                    },
                    requestParamInterfaceDescription: TopicsApiRcmsApi1TopicsMultipleInsertPostRequestDescription,
                },
                {
                    class: TopicsApi,
                    url: "/rcms-api/1/topics/multiple/{topics_id}".replace("{" + "topics_id" + "}", ''),
                    requestMethodName: 'rcmsApi1TopicsMultipleTopicsIdGet',
                    requestRequiredParamSample: {
                        topicsId: {},
                    },
                    requestParamInterfaceDescription: TopicsApiRcmsApi1TopicsMultipleTopicsIdGetRequestDescription,
                },
                {
                    class: TopicsApi,
                    url: "/rcms-api/1/topics/multiple/update/{topics_id}".replace("{" + "topics_id" + "}", ''),
                    requestMethodName: 'rcmsApi1TopicsMultipleUpdateTopicsIdPost',
                    requestRequiredParamSample: {
                        topicsId: {}, inlineObject6: {},
                    },
                    requestParamInterfaceDescription: TopicsApiRcmsApi1TopicsMultipleUpdateTopicsIdPostRequestDescription,
                },
            ];
        },
        enumerable: true,
     ...
     */
    TopicsApi.prototype.rcmsApi1TopicsMultipleGet = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var rcmsApi1TopicsMultipleGetRaw;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        rcmsApi1TopicsMultipleGetRaw = function (requestParameters) { return __awaiter(_this, void 0, void 0, function () {
                            var queryParameters, headerParameters, response;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (requestParameters === null || requestParameters === undefined) {
                                            throw new runtime.RequiredError('request parameter was null or undefined', [
                                                'request parameter was null or undefined when calling rcmsApi1TopicsMultipleGet.',
                                                'This method requires parameters even if defined parameters are all optional (not required).',
                                                'In case of that, please specify empty Object.',
                                                'e.g. rcmsApi1TopicsMultipleGet({})'
                                            ].join('\n'));
                                        }
                                        queryParameters = {};
                                        if (requestParameters.outputFormat !== undefined) {
                        ...
                        return [4 /*yield*/, rcmsApi1TopicsMultipleGetRaw(requestParameters)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     */
    TopicsApi.prototype.rcmsApi1TopicsMultipleInsertPost = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var rcmsApi1TopicsMultipleInsertPostRaw;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        rcmsApi1TopicsMultipleInsertPostRaw = function (requestParameters) { return __awaiter(_this, void 0, void 0, function () {
                            var queryParameters, headerParameters, response;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (requestParameters === null || requestParameters === undefined) {
                                            throw new runtime.RequiredError('request parameter was null or undefined', [
                                                'request parameter was null or undefined when calling rcmsApi1TopicsMultipleInsertPost.',
                                                'This method requires parameters even if defined parameters are all optional (not required).',
                                                'In case of that, please specify empty Object.',
                                                'e.g. rcmsApi1TopicsMultipleInsertPost({})'
                                            ].join('\n'));
                                        }
                                        if (requestParameters.inlineObject5 === null || requestParameters.inlineObject5 === undefined) {
                                            throw new runtime.RequiredError('inlineObject5', 'Required parameter requestParameters.inlineObject5 was null or undefined when calling rcmsApi1TopicsMultipleInsertPost.');
                                        }
                                        queryParameters = {};
                                        if (requestParameters.outputFormat !== undefined) {
                                            queryParameters['_output_format'] = requestParameters.outputFormat;
                        ...
                        return [4 /*yield*/, rcmsApi1TopicsMultipleInsertPostRaw(requestParameters)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     */
    TopicsApi.prototype.rcmsApi1TopicsMultipleTopicsIdGet = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var rcmsApi1TopicsMultipleTopicsIdGetRaw;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        rcmsApi1TopicsMultipleTopicsIdGetRaw = function (requestParameters) { return __awaiter(_this, void 0, void 0, function () {
                            var queryParameters, headerParameters, response;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (requestParameters === null || requestParameters === undefined) {
                                            throw new runtime.RequiredError('request parameter was null or undefined', [
                                                'request parameter was null or undefined when calling rcmsApi1TopicsMultipleTopicsIdGet.',
                                                'This method requires parameters even if defined parameters are all optional (not required).',
                                                'In case of that, please specify empty Object.',
                                                'e.g. rcmsApi1TopicsMultipleTopicsIdGet({})'
                                            ].join('\n'));
                                        }
                                        if (requestParameters.topicsId === null || requestParameters.topicsId === undefined) {
                                            throw new runtime.RequiredError('topicsId', 'Required parameter requestParameters.topicsId was null or undefined when calling rcmsApi1TopicsMultipleTopicsIdGet.');
                                        }
                                        queryParameters = {};
                                        if (requestParameters.outputFormat !== undefined) {
                                            queryParameters['_output_format'] = requestParameters.outputFormat;
                                        ...
                                        return [4 /*yield*/, this.request({
                                                path: "/rcms-api/1/topics/multiple/{topics_id}".replace("{" + "topics_id" + "}", encodeURIComponent(String(requestParameters.topicsId))),
                                                method: 'GET',
                                                headers: headerParameters,
                                                query: queryParameters,
                                            })];
                        ...
                        return [4 /*yield*/, rcmsApi1TopicsMultipleTopicsIdGetRaw(requestParameters)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     */
    TopicsApi.prototype.rcmsApi1TopicsMultipleUpdateTopicsIdPost = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var rcmsApi1TopicsMultipleUpdateTopicsIdPostRaw;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        rcmsApi1TopicsMultipleUpdateTopicsIdPostRaw = function (requestParameters) { return __awaiter(_this, void 0, void 0, function () {
                            var queryParameters, headerParameters, response;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (requestParameters === null || requestParameters === undefined) {
                                            throw new runtime.RequiredError('request parameter was null or undefined', [
                                                'request parameter was null or undefined when calling rcmsApi1TopicsMultipleUpdateTopicsIdPost.',
                                                'This method requires parameters even if defined parameters are all optional (not required).',
                                                'In case of that, please specify empty Object.',
                                                'e.g. rcmsApi1TopicsMultipleUpdateTopicsIdPost({})'
                                            ].join('\n'));
                                        }
                                        if (requestParameters.topicsId === null || requestParameters.topicsId === undefined) {
                                            throw new runtime.RequiredError('topicsId', 'Required parameter requestParameters.topicsId was null or undefined when calling rcmsApi1TopicsMultipleUpdateTopicsIdPost.');
                                        }
                                        if (requestParameters.inlineObject6 === null || requestParameters.inlineObject6 === undefined) {
                                            throw new runtime.RequiredError('inlineObject6', 'Required parameter requestParameters.inlineObject6 was null or undefined when calling rcmsApi1TopicsMultipleUpdateTopicsIdPost.');
                                        }
                                        queryParameters = {};
                                        if (requestParameters.outputFormat !== undefined) {
                                            queryParameters['_output_format'] = requestParameters.outputFormat;
                                        ...
                                        return [4 /*yield*/, this.request({
                                                path: "/rcms-api/1/topics/multiple/update/{topics_id}".replace("{" + "topics_id" + "}", encodeURIComponent(String(requestParameters.topicsId))),
                                                method: 'POST',
                                                headers: headerParameters,
                                                query: queryParameters,
                        ...
                        return [4 /*yield*/, rcmsApi1TopicsMultipleUpdateTopicsIdPostRaw(requestParameters)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
